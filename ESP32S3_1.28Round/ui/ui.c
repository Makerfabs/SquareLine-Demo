...
const lv_img_dsc_t * ui_imgset__28[1] = {&ui_img_1_28_png};
const lv_img_dsc_t * ui_imgset_160x[1] = {&ui_img_160x40_png};
...
void ui_Screen1_screen_init(void)
{
    ...
    lv_obj_set_style_bg_img_src(ui_Screen1, &ui_img_1_28_png, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui_Label2, "ESP32-S3 Round SPI TFT with Touch 1.28\"");
    ...
    lv_img_set_src(ui_Image2, &ui_img_160x40_png);
    lv_obj_set_width(ui_Image2, 160);
