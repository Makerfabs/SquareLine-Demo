...
const lv_img_dsc_t * ui_imgset_[1] = {&ui_img_4_png};
...
void ui_Screen1_screen_init(void)
{
    ...
    lv_obj_set_style_bg_img_src(ui_Screen1, &ui_img_4_png, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui_Label2, "ESP32-S3 Parallel IPS with Touch 4.0\" 480*480 ST7701");
    lv_obj_set_style_text_font(ui_Label2, &lv_font_montserrat_30, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_Label1 = lv_label_create(ui_Screen1);
    lv_obj_set_width(ui_Label1, 270);
